...
class KNNWrapper(object):
    ...
    def break_into(self, model):
        # hooking into the model's forward pass. It registers hooks to capture the activations that are later used for kNN retrieval.
        self.model = model
    ...
    def post_forward_hook(self, module, input, output):
        ...
        # make sense as the decoder model is typically next-token predictor
